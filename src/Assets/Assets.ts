const ASSET_URL = 'https://res.cloudinary.com/djeukcxxb/image/upload/v1633965657/Habitual';

export const Circles = `${ASSET_URL}/Circles.webp`;
...
export const Piano = `${ASSET_URL}/Piano.webp`;
export const Fruit = `${ASSET_URL}/Fruit.webp`;
export const Circle = `${ASSET_URL}/Circle.webp`;
export const Check = `${ASSET_URL}/Check.webp`;
